...
import { Timer, LayoutDashboard, Calendar, History as HistoryIcon, LogOut, Flame, Clock, User, Sun, Moon } from 'lucide-react';
  ...
  return (
    <>
      ...
      <nav className="navbar glass-card mobile-hide">
        <div className="nav-left" style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '8px' }}>
